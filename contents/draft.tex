...
\begin{document}
    ...
    \begin{figure*}[t]
        \centerline{\includegraphics[width=0.8\textwidth]{fig;sample-v2}}
    ...
    \begin{figure*}[t]
        \centerline{\includegraphics[width=0.9\textwidth]{fig;lattice-v2}}
    ...
    \begin{figure*}[t]
        \centerline{\includegraphics[width=0.9\textwidth]{fig;ranking-v1}}
