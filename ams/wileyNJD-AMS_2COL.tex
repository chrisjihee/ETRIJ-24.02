...
\begin{document}
    ...
    \abstract[Abstract]{
        ...
        Korean morpheme analysis plays a basic and important role enough to be called the first step in Korean language analysis.
        ...
        In addition, various methods for morpheme analysis have been proposed, but efficient methods such as BPE are mainly used in applications intended to be used as tokenizers for deep learning.
        ...
        For a number of various cases whose rankings have been changed through re-ranking, it is possible to improve performance while maintaining speed by updating the cost matrix of the lattice-based morpheme analysis system in the future.
